...
class Easyap_Admin
{
    ...
    public function enqueue_scripts($page)
    {
        ...
        wp_enqueue_style('easyap-admin', EASYAP_URL . 'assets/css/admin.css', null, '1.0.3');
        ...
        wp_enqueue_script('easyap-admin', EASYAP_URL . 'assets/js/admin.js', array('jquery'), '1.0.3', true);
    }
