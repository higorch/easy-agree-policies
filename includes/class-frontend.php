...
class Easyap_Frontend
{
    ...
    {
        wp_enqueue_style('easyap-frontend', EASYAP_URL . '/assets/css/frontend.css', null, '2.0.0');
        wp_enqueue_script('easyap-frontend', EASYAP_URL . '/assets/js/frontend.js', array('jquery'), '2.0.0', true);
    }
